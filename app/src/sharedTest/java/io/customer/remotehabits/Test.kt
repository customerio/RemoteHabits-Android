...
abstract class Test {
    ...
    /**
     * Android test rule to run Architecture Components synchronously for predictable tests
     */
    protected val instantTaskRule = InstantTaskExecutorRule()
    ...
    protected inline fun <reified T: Any> getJsonAsset(asset: TestAssetFiles): JsonTestAsset<T> {
        ...
        return JsonTestAsset(fileContents, data)
    }

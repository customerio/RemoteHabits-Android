package io.customer.remotehabits.mock
...
class MockWebServer(private val mockWebServer: MockWebServer) {
     ...
     *
     * There is a way to make this url not lateinit. `val url: String = "http://localhost:13714/" // 13714 is a random port number. One that a program is probably not using on the device already` if you don't want to have to add code to your test function.
